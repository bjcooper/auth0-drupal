...
final class Authentication implements AuthenticationInterface {
   ...
   *
   * @param \Auth0\SDK\Configuration\SdkConfiguration|arraymixed $configuration
   ...
   * @param string|null $clientId
   *   Optional. Client ID to use. Defaults to the SDK's configured Client ID.
   * @param arrayint|string|null|null $params
   *   Optional. Additional parameters to include with the request. See @link for details.
   *
   * @throws \Auth0\SDK\Exception\ConfigurationException When a $clientId is not configured.
   *
  ...
  public function getLoginLink(
    ...
    Toolkit::assert([
          [$state, ArgumentException::missing('state')],
    ])->isString();
    ...
    return sprintf(
          ...
          http_build_query(Toolkit::merge([
            'state' => $state,
            'client_id' => $this->configuration->getClientId(ConfigurationException::requiresClientId()),
   ...
   *
   * @param arraymixed|null $body
   *   Optional. Additional content to include in the body of the API request. See @link for details.
   * @param arrayint|string|null $headers
  ...
  public function passwordlessStart(
    ...
    return $this->getHttpClient()
      ...
      ->withBody(Toolkit::merge([
        'client_id' => $this->configuration->getClientId(ConfigurationException::requiresClientId()),
        'client_secret' => $this->configuration->getClientSecret(ConfigurationException::requiresClientSecret()),
      ], $body))
      ->withHeaders($headers)
      ->call();
  }
   ...
   * @param arraystringstring|null|null $params
  ...
  public function emailPasswordlessStart(
    ...
    Toolkit::assert([
          [$email, ArgumentException::missing('email')],
    ])->isEmail();

    Toolkit::assert([
          [$type, ArgumentException::missing('type')],
    ])->isString();
  ...
  public function smsPasswordlessStart(
    ...
    Toolkit::assert([
          [$phoneNumber, ArgumentException::missing('phoneNumber')],
    ])->isString();
  ...
  public function userInfo(
    ...
    Toolkit::assert([
          [$accessToken, ArgumentException::missing('accessToken')],
    ])->isString();
   ...
   *   Denotes the type of flow being used. See @link for details.
   * @param arrayint|string|null|null $params
   *   Optional. Additional content to include in the body of the API request. See @link for details.
   * @param arrayint|string|null $headers
   *   Optional. Additional headers to send with the API request.
  ...
  public function oauthToken(
    ...
    Toolkit::assert([
          [$grantType, ArgumentException::missing('grantType')],
    ])->isString();
  ...
  public function codeExchange(
    ...
    Toolkit::assert([
          [$code, ArgumentException::missing('code')],
    ])->isString();
  ...
  public function login(
    ...
    Toolkit::assert([
          [$username, ArgumentException::missing('username')],
          [$password, ArgumentException::missing('password')],
          [$realm, ArgumentException::missing('realm')],
    ])->isString();
  ...
  public function refreshToken(
    ...
    Toolkit::assert([
          [$refreshToken, ArgumentException::missing('refreshToken')],
    ])->isString();
  ...
  public function dbConnectionsSignup(
    ...
    Toolkit::assert([
          [$email, ArgumentException::missing('email')],
          [$password, ArgumentException::missing('password')],
          [$connection, ArgumentException::missing('connection')],
    ])->isString();
